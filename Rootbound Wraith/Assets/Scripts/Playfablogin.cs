...
public class Playfablogin : MonoBehaviour
{
    ...
    public void login()
    {
        PlayFab.PlayFabSettings.staticSettings.TitleId = "1A4656";
    ...
    {
        coins = result.VirtualCurrency["RS"];
        currencyText.text = "You Have : " + coins.ToString() + " " + CurrencyName + ". Please spend them wisely!";
    }
